...
namespace EGamePlay.Combat
{
    ...
    public class SpellAction : Entity, IActionExecute
    {
        ...
        public AbilityExecution SkillExecution { get; private set; }
        public List<CombatEntity> SkillTargets { get; set; } = new ();
        ...
        {
            if (SkillExecution is not { IsDisposed: true }) return;
            PostProcess();
            FinishAction();
        }
        //后置处理
